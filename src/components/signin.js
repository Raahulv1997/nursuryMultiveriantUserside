    ...
    const onUserSinginClick = async (event) => {
        ...
        if (validate() && state.otp) {
            if (term === true) {
                ...
                console.log(response ,"fgkdhftguhdr",
            ...
            if (response.response === "send otp on your mail") {
                ...
                setOtpBox(true);
                setLoading(false)
            }else if (response.response === "email already exists, please use logIn way"){
                setLoading(false)
                                    ...
                                    <ul className="user-form-social">
                                        <li>
                                            <Link className="facebook">
                                                ...
                                                </i>Join with facebook</Link></li><li><Link className="twitter">
                                                    <i className="fab fa-twitter"></i>Join with twitter</Link>
                                        </li>
                                        <li>
                                            <Link className="google">
                                                <i className="fab fa-google">
                                                </i>Join with google</Link>
                                        </li>
                                        <li>
                                            <Link className="instagram"><i className="fab fa-instagram">
                                            </i>Join with instagram</Link></li></ul>
                                    <div className="user-form-divider"><p>or</p>
                                    </div>
                                    <form className="user-form" onSubmit={onUserSinginClick}>
                                        <div className="form-group">
                                            <input type="text"
                                                ...
                                                onChange={onInputChange} name="name" value={state.name} />
                                        ...
                                        <div className="form-group">
                                            <input type="email"
                                                ...
                                                onChange={onInputChange} name="email" value={state.email} />
                                        ...
                                        <div className="form-group">
                                            <input type="password"
                                                ...
                                                onChange={onInputChange} name="password" value={state.password} />
                                        ...
                                        <div className="form-group">
                                            <input type="password"
                                                ...
                                                onChange={onInputChange} name="confirm_password" value={state.confirm_password} />
                                            {/*----ERROR MESSAGE FOR PASSWORD----*/}
                                            {errors.confirm_password && (
                                                <span>

...
const Footer = () => {
  return (
    <>
     {/* Discount */}
     <section className="news-part" style={{ background: `url(${newspaper}) no-repeat center` }}>
       ...
       <div className="row align-items-center">
         ...
         <div className="col-md-7 col-lg-6 col-xl-5">
           <form className="news-form">
             ...
             <button><span><i className="icofont-ui-email"></i>Subscribe</span></button></form>
         </div>
       </div>
     </div>
   </section>
          ...
          <div className="col-sm-6 col-xl-3">
            <div className="footer-widget">
              ...
              <div className="footer-app">
                ...
                <Link to={""}><img src={appStore} alt="app" /></Link>
              </div>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-12">
            <div className="footer-bottom">
              <p className="footer-copytext">© All Copyrights Reserved by
                <Link to={""}>Mironcoder</Link>
              </p>
              <div className="footer-card">
                <Link to={""}><img src={payment01} alt="payment" /></Link>
                <Link to={""}><img src={payment02} alt="payment" /></Link>
                <Link to={""}><img src={payment03} alt="payment" /></Link>
                <Link to={""}><img src={payment04} alt="payment" /></Link>
              </div>
            </div>
          </div>
        </div>

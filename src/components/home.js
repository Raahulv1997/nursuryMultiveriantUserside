    ...
    <div>
      ...
      <section className="section recent-part">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="section-btn-25"><Link to={"/shop"} className="btn btn-outline">
                <i className="fas fa-eye"></i><span>show more</span></Link></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="section promo-part">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="promo-img"><Link><img src={promo} alt="promo" /></Link></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="col-lg-6 mx-auto">
              <div className="countdown-content">
                ...
                <div className="countdown countdown-clock" data-countdown="2022/12/22">
                  <span className="countdown-time"><span>00</span>
                    <small>days</small>
                  </span>
                  <span className="countdown-time"><span>00</span>
                ...
                <Link className="btn btn-inline" to="/shop">
                  <i className="fas fa-shopping-basket"></i><span>shop now</span></Link>
              </div>
            </div>
            <div className="col-lg-1"></div>
            <div className="col-lg-5">
              <div className="countdown-img"><img src={countdown} alt="countdown" />

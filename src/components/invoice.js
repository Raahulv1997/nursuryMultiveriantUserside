                            ...
                            <div className="account-card">
                                ...
                                <div className="account-content">
                                    <div className="invoice-recieved">
                                        <h6>order number <span>{orderDetails.order_id}</span>
                                        </h6>
                                        <h6>order date <span>{moment(orderDetails.order_date).format("MMMM DD,YYYY")}</span>
                                        </h6>
                                        <h6>
                                            total amount <span>₹{(orderDetails.total_amount)}</span>
                                        </h6>
                                        <h6>payment method <span>{orderDetails.payment_mode}</span>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="account-card">
                                ...
                                <div className="account-content">
                                    <ul className="invoice-details">
                                        <li>
                                            <h6>Total Item</h6>
                                            <p>{orderDetails.total_order_product_quantity > 1 ? orderDetails.total_order_product_quantity + "Items" : orderDetails.total_order_product_quantity}</p>
                                        </li>
                                        <li>
                                            <h6>Order Time</h6>
                                            <p>{moment(orderDetails.order_date).format('h:mm A, MM-DD-YYYY')}</p>
                                        </li>
                                        <li>
                                            <h6>Delivery Time</h6>
                                            <p>{moment(orderDetails.delivery_date).fromNow()} Express Delivery</p>
                                        </li>
                                        <li>
                                            <h6>Delivery Location</h6>
                                            <p>{orderDetails.address} {orderDetails.pin_code},{orderDetails.city}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="account-content">
                                    <ul className="invoice-details">
                                        ...
                                        <li>
                                            ...
                                            <p className='text-danger'>- ₹ {(TotalPrice[2].toFixed(2))}</p>
                                        </li>
                                        <li>
                                            <h6>GST</h6>
                                            {/* Gst Calculation */}
                                            <p>₹ {(TotalPrice[1]).toFixed(2)}</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <p>₹ {((TotalPrice[3] + 100).toFixed(2))}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
